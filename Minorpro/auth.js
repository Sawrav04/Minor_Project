...
document.addEventListener('DOMContentLoaded', () => {
    ...
    signupForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            await setDoc(userRef, {
                ...
                status: role === 'carrier' ? 'pending' : 'approved' // Carriers need approval, others are auto-approved
            });
            ...
            if (role === 'carrier') {
                ...
                window.location.href = 'logistic-manager-dashboard.html';
            }
    ...
    loginForm.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            if (!userRole || (userRole !== 'carrier' && userRole !== 'shipper' && userRole !== 'manager')) {
                throw new Error('Invalid user role');
            }

            // Check if carrier is approved
            if (userRole === 'carrier' && userStatus === 'rejected') {
                throw new Error('Your carrier account has been rejected');
            }
...
function getErrorMessage(errorCode) {
    switch (errorCode) {
        ...
        case 'Your carrier account has been rejected':
            return 'Your carrier account application has been rejected. Please contact support.';
        default:
